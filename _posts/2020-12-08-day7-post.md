...
ex)  
$ \begin{bmatrix} a_11 & a_12 & a_13 \cr a_21 & a_22 & a_23 \cr a_31 & a_32 & a_33 \end{bmatrix} = \begin{bmatrix} r_1\cr r_2\cr r_3 \end{bmatrix} $  
$ \begin{bmatrix} a_11 & a_12 & a_13 \cr a_21 & a_22 & a_23 \cr a_31 & a_32 & a_33 \end{bmatrix} = \begin{bmatrix} c_1 & c_2 & c_3 \end{bmatrix} $  
$3 \times 3$ 행렬을 row vector로 이루어져 있는 $3 \times 1$ 행렬로 표현가능하고 column vector 로 이루어져 있는 $1 \times 3$ 행렬로도 표현이 가능하다.  


$AB = A \begin{bamtrix} Ab_1 & Ab_2 & ... & Ab_n \end{bmatrix} = C$  
두 행렬의 곱 AB = C 를 위와 같이 matrix-column vector prodects로 볼 수 있다. 

$AB = A \begin{bamtrix} {a_1}B \cr {a_2}B \cr ... \cr {a_n}B \end{bmatrix} = C$  
